...
import { deletePromo, promoCodeList } from "../../../store/actions";
import {
  DataTable,
  DataTableBody,
  DataTableHead,
...
const PromoCodesIndex = () => {
  ...
  const PromoCodeData = useSelector((s) => s.PromoReducer.promoCodeList?.data);
  const totalCount = useSelector(
    (s) => s?.PromoReducer.promoCodeList?.totalcount
  );
  const loading = useSelector((s) => s?.PromoReducer?.loading);
  ...
  const handleDelete = () => {
    const callBack = (response) => {
      ...
      if (response.status == "success") {
        ...
        setDelete(false);
        dispatch(promoCodeList());
      } else {
        toast.error(response.message);
      }
    };
    dispatch(deletePromo(Delete.dumpId, callBack));
  };
          ...
          <Row>
            <Col lg="12" className="my-2">
              <div className="top mb-2">
                <h4 className="dashboard-head m-0">Promo Codes</h4>
              </div>
            </Col>
                ...
                <div className="table-responsive py-3">
                  <table className="table common-table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <p className="theme-clr m-0 fw-sbold"> FIRST ORDER</p>
                        </td>
                        <td>
                        ...
                        <td>
                          <p className="m-0">05 Dec 2022</p>
                        </td>
                        <td>
                          <p className="m-0">31 Dec 2022</p>
                        </td>
                        <td>
...
export default PromoCodesIndex;
