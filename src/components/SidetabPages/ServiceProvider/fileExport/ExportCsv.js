...
// import { exportmanageUser } from "../../../store/actions";
import { useDispatch, useSelector } from "react-redux";
import { exportServiceProvider } from "../../../../store/actions";
...
const ExportCsv = (props) => {
  ...
  const Data = useSelector(
    (s) => s?.ExportServiceProvider?.exportProvider?.data
  );
  const loading = useSelector((s) => s?.ExportServiceProvider?.loading);
  ...
  const fetchData = () => {
    ...
    dispatch(exportServiceProvider(body));
  };
