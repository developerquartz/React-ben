...
import { serviceList, deleteService } from "../../../../store/actions";
...
const ServiceIndex = () => {
  ...
  const ServiceData = useSelector(
    (s) => s?.Catalog?.serviceList?.data
  );

  const totalCount = useSelector(
    (s) => s?.Catalog?.serviceList?.totalcount
  );
  ...
  const handleDelete = () => {
    ...
    dispatch(deleteService({ serviceId: Delete.dumpId }, callBack));
  };
                ...
                <DataTable className="">
                  ...
                  <DataTableBody
                    ...
                    actionBtn={[
                      ...
                      {
                        label: "Edit", icon: "", link: "/catalog/services/edit",
                      },
                    ]}
                  />
