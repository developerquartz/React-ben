...
const AddServiceIndex = () => {
  ...
  const ServiceData = useSelector((s) => s.Catalog.serviceDetails?.data);

  useEffect(() => {
    if (compMounted.current) {
      let addOns = ServiceData?.addOns.map((addOn) => {
        return addOn._id;
      });
      setData((pre) => ({
        ...pre,
        ...
        adminCommission: ServiceData?.serviceCost,
        distanceCost: ServiceData?.distanceCost,
        setPrice: ServiceData?.setPrice,
        addOns: addOns,
      }));
    } else {
  ...
  useEffect(() => {
    if (EditId) {
      dispatch(getServiceDetails(EditId.toString()));
    }
    setData((pre) => ({
      ...pre,
      serviceId: EditId,
  ...
  useEffect(() => {
    if (data.category) {
      dispatch(serviceAddOnList({ category: data?.category, limit: 100 }));
    }
  }, [data?.category]);

  const serviceAddOnData = useSelector((s) => s.Catalog.serviceAddOnList?.data);
          ...
          <Row className="justify-content-center">
            <Col lg="10" className="my-2">
              <div className="top mb-2">
                <Breadcrumb>
                  <Breadcrumb.Item href="/catalog/services">
                    Services
                  </Breadcrumb.Item>
                        ...
                        <Row>
                          <Col lg="12" className="my-2">
                            {/* <p className="text-muted small-text m-0">
                              Configure your Service Showcase...
                            </p> */}
                            ...
                            />
                            <p className="text-muted small-text m-0">
                              Type your service name, customer can find this
                      ...
                      <Form>
                        <Row>
                          <Col lg="12" className="my-2">
                            ...
                            ></textarea>
                            <p className="text-muted small-text m-0">
                              2-3 line description text about your service, we
                      ...
                      <Form>
                        <Col lg="12" className="my-2 ">
                          ...
                          <p className="text-muted small-text m-0">
                            ...
                            this service using this category.
                          </p>
                        </Col>
                      </Form>
                    </div>
                        ...
                        <Row>
                          <Col lg="12" className="my-2">
                            ...
                            <p className="py-1 text-muted small-text m-0">
                              We recommend good quality Service image that is
                              helpful to showcase your Service. Max. upload file
                              size: 5MB
                            </p>
                          </Col>
                        </Row>
...
export default AddServiceIndex;
