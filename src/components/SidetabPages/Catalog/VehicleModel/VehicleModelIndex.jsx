...
import { vehicleModelList, deleteVehicleModel } from "../../../../store/actions";
...
const VehicleModelIndex = () => {
  ...
  const VehicleMakeData = useSelector(
    (s) => s?.Catalog?.vehicleModelList?.data
  );

  const totalCount = useSelector(
    (s) => s?.Catalog?.vehicleModelList?.totalcount
  );
  ...
  const handleDelete = () => {
    ...
    dispatch(deleteVehicleModel({ vehicleModelId: Delete.dumpId }, callBack));
  };
  ...
  return (
    <>
          ...
          <Row>
            <Col lg="12" className="my-2">
              <div className="top mb-2">
                <h4 className="dashboard-head m-0">Vehicle Models</h4>
              </div>
            </Col>
                  ...
                  <DataTableBody
                    ...
                    actionBtn={[
                      { label: "Delete", icon: "", action: DeletePopup },
                      {
                        label: "Edit",
                        icon: "",
                        link: "/catalog/vehicle-models/edit",
                      },
                      ,
                    ]}
                  />
      ...
      >
        ...
        <Modal.Body>
          <div className="text-center py-3">
            <h2 className="pop-head m-0 pb-2">Import Vehicle Models</h2>
            <div className="py-2">
