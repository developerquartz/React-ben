...
import { providerWithdrawlList, processWithdrawal, cancelWithdrawal } from "../../../../store/actions";
...
const WithdrawalTransactionIndex = () => {
  ...
  const providerWithdrawlData = useSelector((s) => s?.Dashboard?.providerWithdrawlList?.data);
  const totalCount = useSelector((s) => s.Dashboard?.providerWithdrawlList?.totalcount);
  ...
  const getTableRecords = () => {
    ...
    dispatch(providerWithdrawlList(body));
  };
  ...
  const ProcessPopup = (state, id = "", amount = 0, status = "", text = "", providerDetails = {}, transactionId = "") => {
    setProcess((pre) => ({
      ...pre,
      open: state,
      withdrawlRequestId: id,
      amount: amount,
      status: status,
      text: text,
  ...
  const handleProcessRequest = (e) => {
    ...
    dispatch(processWithdrawal(process, callBack));
  };
  ...
  const handleCancelRequest = (e) => {
    ...
    dispatch(cancelWithdrawal({ withdrawlRequestId: process?.withdrawlRequestId, transactionId: process?.transactionId }, callBack));
  };
          ...
          <Row>
            <Col lg="12" className="my-2">
              <div className="top mb-2">
                <h4 className="dashboard-head m-0">Withdrawal Transactions</h4>
              </div>
            </Col>
            <Col lg="12" className="my-2">
                ...
                <div className="table-responsive py-3">
                  <DataTable className="">
                    ...
                    <DataTableBody
                      loading={loading}
                      column={columnData}
                      data={providerWithdrawlData}
                      page={state.page}
                      rowsPerPage={state.rowsPerPage}
                      actionBtn={[
                        { label: "Process", icon: "", action: ProcessPopup },
                      ]}
                    />
                    {providerWithdrawlData?.length > 0 && (
                      <DataTablePagination
                        count={totalCount}
                        rowsPerPage={state.rowsPerPage}
                        page={state.page}
                ...
                <div className="table-responsive py-3">
                  <table className="table common-table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <p className=" m-0 ">09 Dec 2022, 11:35 AM</p>
                        </td>
                        <td>
                          <p className="m-0">Rohit</p>
                        </td>
                        <td>
                          <p className="m-0">Debit</p>
                        </td>
                        <td>
                          <p className="m-0 text-danger fw-sbold">-₦2517.42</p>
                        </td>
                        <td>
                          <p className="m-0"> Withdrawl with Ref: Account.</p>
                        </td>
                        <td>
            ...
            <Row>
              <Col lg="12" className="my-2">
                <label htmlFor="" className="form-label2 m-0 pb-1">
                  ...
                  <p>
                    If you want to process this transaction, Enter transaction ID and click Processed.
                  </p>
                  If you want to cancel this transaction, click Cancel.
                </label>
              </Col>
              ...
              <Col lg="6" className="my-2">
                ...
                <input
                  type="text"
                  name="balance"
                  value={process?.providerDetails?.walletDetails?.balance}
              ...
              <Col lg="6" className="my-2">
                ...
                <input
                  type="text"
                  name="bankName"
                  value={process?.providerDetails?.accountDetails?.bankName}
                  className="form-control"
                  disabled
                />
              </Col>
              ...
              <Col lg="6" className="my-2">
                ...
                <input
                  type="text"
                  name="bankName"
                  value={process?.providerDetails?.accountDetails?.accountHolderName}
                  className="form-control"
                  disabled
                />
              </Col>
              ...
              <Col lg="6" className="my-2">
                ...
                <input
                  type="text"
                  name="balance"
                  value={process?.providerDetails?.accountDetails?.accountNumber}
                  className="form-control"
                  disabled
                />
              </Col>
              ...
              <Col lg="6" className="my-2">
                <label htmlFor="" className="form-label2 m-0 pb-1">
                  Provider Account Sort Code
                </label>
                <input
                  type="text"
                  name="bankName"
                  value={process?.providerDetails?.accountDetails?.sortNumber}
                  className="form-control"
                  disabled
                />
              </Col>
              ...
              <Col lg="6" className="my-2">
                ...
                <input
                  type="text"
                  name="transactionId"
                  value={process?.transactionId}
                  className="form-control"
                  onChange={handleTransactionChange}
                  disabled={process?.status === "requested" ? false: true}
                />
              </Col>
            </Row>
          </Form>
...
export default WithdrawalTransactionIndex;