...
import { exportProviderWithdrawlRequests } from "../../../../../store/actions";
...
const ExportCsv = (props) => {
  ...
  const Data = useSelector((s) => s?.Export?.exportProviderWithdrawlRequests?.data);
      ...
      Data.map((k) => {
        return {
          ...
          createdAt: k["createdAt"]
            ...
            : "",
            providerDetails: k["providerDetails"]? k["providerDetails"]?.name : ""
        };
      });
  ...
  const fetchData = () => {
    ...
    dispatch(exportProviderWithdrawlRequests(body));
  };
