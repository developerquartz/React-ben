...
import { postTwitter } from "../../../../store/actions";
...
export const TwitterBanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validate.error) {
      setLoading(true);
      dispatch(postTwitter(body, callBack));
  ...
  return (
    <>
      <section className="banneryou-tube banner-twitter position-relative">
        <Container>
          <Row>
            <Col md={6}>
            ...
            <Col md={6}>
              <div className="right-insta-banner position-absolute">
                <img
                  src="../../../assets/images/twitter-banner-new.png"
                  alt=""
                  className="img-fluid"
                />
              </div>
