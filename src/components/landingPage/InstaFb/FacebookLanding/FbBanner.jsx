...
import { postFacebook } from "../../../../store/actions";
import { toast } from "react-toastify";

export const FbBanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validate.error) {
      setLoading(true);
      dispatch(postFacebook(body, callBack));
  ...
  return (
    <>
      <section className="landing-facebook main-fb-banner position-relative">
        <img
          src="../../../assets/images/facebook-lnding-banner.png"
