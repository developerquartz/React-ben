...
import { postTiktok } from "../../../../store/actions";
import { toast } from "react-toastify";

export const TikTokBanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validate.error) {
      setLoading(true);
      dispatch(postTiktok(body, callBack));
  ...
  return (
    <>
      <section className="banneryou-tube banner-twitter tiktok-banner position-relative">
        <Container>
          <Row>
            <Col md={6}>
            ...
            <Col md={6}>
              <div className="right-insta-banner position-absolute">
                <img
                  src="../../../assets/images/tiktok-img-banner.png"
                  alt=""
                  className="img-fluid"
                />
              </div>
