...
import { postFacebook, postInstagram } from "../../../../store/actions";
...
export const InstaBanner = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validate.error) {
      setLoading(true);
      dispatch(postInstagram(body, callBack));
  ...
  return (
    <>
      <section className="landing-facebook insta-banner insta-main-banner position-relative">
        <img
          src="../../../assets/images/insta-abnner.png"
          ...
          <Row>
            <Col md={6}>
              <div className="main-banner-facebook">
                {/* <div className="logo-fb-lnading">
                    <img src="../../../assets/images/logo-facebook-page.png" alt="" className="img-fluid w-100" />
                </div> */}
            ...
            <Col md={6}>
              <div className="right-insta-banner position-absolute">
                <img
                  src="../../../assets/images/baner-insta-right.png"
                  alt=""
                  className="img-fluid"
                />
              </div>
